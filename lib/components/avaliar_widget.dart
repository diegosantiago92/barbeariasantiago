...
class _AvaliarWidgetState extends State<AvaliarWidget> {
  ...
  void initState() {
    ...
    _model.inputReviewExperienceController ??= TextEditingController();
    _model.inputReviewExperienceFocusNode ??= FocusNode();
  }
            ...
            children: [
              Expanded(
                child: Padding(
                  ...
                  child: TextFormField(
                    controller: _model.inputReviewExperienceController,
                    focusNode: _model.inputReviewExperienceFocusNode,
                    autofocus: true,
                    obscureText: false,
                    decoration: InputDecoration(
                      labelText: 'Escreva a sua avaliação',
                      labelStyle:
                    ...
                    validator: _model.inputReviewExperienceControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
