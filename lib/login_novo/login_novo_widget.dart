...
class LoginNovoWidget extends StatefulWidget {
  const LoginNovoWidget({Key? key}) : super(key: key);

  @override
  _LoginNovoWidgetState createState() => _LoginNovoWidgetState();
}
...
class _LoginNovoWidgetState extends State<LoginNovoWidget> {
  ...
  void initState() {
    ...
    _model.enderecoEmailController ??= TextEditingController();
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 0.0, 12.0),
                                child: Text(
                                  'Faça seu login para agendar seu horário',
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 12.0, 16.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.enderecoEmailController,
                                    ...
                                    validator: _model
                                        .enderecoEmailControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              ...
                              if (!(isWeb
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (_model.enderecoEmailController.text
                                          .isEmpty) {
                                      ...
                                      await authManager.resetPassword(
                                        email:
                                            _model.enderecoEmailController.text,
                                        context: context,
                                      );
                                    },
