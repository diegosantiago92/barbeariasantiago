...
import '/components/bookaction_widget.dart';
...
import 'tela_agendar_model.dart';
export 'tela_agendar_model.dart';

class TelaAgendarWidget extends StatefulWidget {
  const TelaAgendarWidget({Key? key}) : super(key: key);

  @override
  _TelaAgendarWidgetState createState() => _TelaAgendarWidgetState();
}

class _TelaAgendarWidgetState extends State<TelaAgendarWidget>
    with TickerProviderStateMixin {
  late TelaAgendarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaAgendarModel());
